<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add-category.aspx.cs" Inherits="WebBanLaptop.add_category" %>
            ...
            <div>
                ...
                <table style="width: 100%;">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="name" runat="server" placeholder="Nhập tên loại"></asp:TextBox>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
